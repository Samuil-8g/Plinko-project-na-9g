...
class Ball(pygame.sprite.Sprite):
    def __init__(self, pos, space, board, delta_time, money_manager):  
        super().__init__()
        self.display_surface = pygame.display.get_surface()
        self.space = space
        self.board = board
        self.delta_time = delta_time
        self.money_manager = money_manager  # store reference
    ...
    def update(self):
        ...
        for multi in multi_group:
            if pygame.sprite.collide_rect(self, multi):
                ...
                self.money_manager.update_balance(multi.multi_amt)  # <-- Add this line
